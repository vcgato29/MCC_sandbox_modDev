...
if (str _cargo == "[[],[],[],[]]") then {
    ...
    _cargo = [format ["SERVER_%1_%2",toupper worldName,toUpper missionName], "vaultObjects", "vaultObjects", "read",[],true] call MCC_fnc_handleDB;
    if (str _cargo == "[]") then {
       _cargo = [[],[],[],[]];
    };
	...
	[format ["SERVER_%1_%2",toupper worldName,toUpper missionName], "vaultObjects", "vaultObjects", "write",_cargo,true] call MCC_fnc_handleDB;
};